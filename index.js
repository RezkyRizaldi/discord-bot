...
client.on('guildMemberAdd', member => {
    ...
    const channel = member.guild.channels.cache.find(ch => ch.name === '•chat-kalem•');
    ...
    // console.log('Dapet Channel');

    channel.send(`Welkam di Vtuber Sub Indo, ${member}! Mohon untuk pahami ${redirch} terlebih dahulu, terima kasih.`);
});
...
function play(guild, song){
    ...
    .play(
        ytdl(song.url, { filter: "audioonly", highWaterMark: 1 << 25 }), { bitrate: 64000 }
    )
    .on("finish", () => {
